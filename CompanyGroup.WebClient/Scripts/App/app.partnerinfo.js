...
companyGroup.partnerinfo = $.sammy(function () {
    ...
    this.post('#/invoiceinfoByFilter', function (context) {
        ...
        invoiceInfoRequest.Sequence = 1;
        invoiceInfoRequest.CurrentPageIndex = 1;
        invoiceInfoRequest.ItemsOnPage = 30;
        loadInvoiceInfoByFilter();
    });
    ...
    var loadInvoiceInfoByFilter = function () {
	 ...
	 //termék adatlap
    /*this.get('#/details/:ItemId/:dataAreaId', function (context) {
 
	    var productId = context.params['ItemId'];
    ...
    this.get('#/refreshdetails/:ItemId/:dataAreaId', function (context) {
