...
companyGroup.registration = $.sammy(function () {
    ...
    this.bind('showDataCheck', function (e, data) {
		...
		var submit_contact ='';
		 ...
		 if ($("#txt_contactpersonfirstname").val() != '' || $("#txt_contactpersonlastname").val() != '' || $("#txt_contactpersonemail").val() != '' || $("#txt_contactpersonpassword").val() != '' || $("#txt_contactpersonpassword2").val() != ''  ) {
