...
companyGroup.utils = (function () {
    ...
    function create() {
        return {
            ...
            getPrimaryPictureUrl: function (id) {
                return _pictureBaseApiUrl + 'GetPrimaryPicture/?Id=' + id + '&MaxWidth=500&MaxHeight=500';
            },
            ...
            getNewsletterApiUrl: function (url) {
                return _newsletterUrl + url;
            },
            setNewsletterApiUrl: function (url) {
                _newsletterUrl = url;
            },
