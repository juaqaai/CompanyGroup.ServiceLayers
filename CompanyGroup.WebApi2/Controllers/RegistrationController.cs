    ...
    public class RegistrationController : ApiBaseController
    {
        ...
        public HttpResponseMessage GetByKey(CompanyGroup.Dto.ServiceRequest.GetRegistrationByKey request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController GetByKey {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage AddNew(CompanyGroup.Dto.ServiceRequest.AddNewRegistration request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController AddNew {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage Remove(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController Remove {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage Post(CompanyGroup.Dto.ServiceRequest.PostRegistration request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController Post {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage UpdateDataRecording(CompanyGroup.Dto.ServiceRequest.UpdateDataRecording request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController UpdateDataRecording {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage UpdateRegistrationData(CompanyGroup.Dto.ServiceRequest.UpdateRegistrationData request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController UpdateRegistrationData {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage UpdateWebAdministrator(CompanyGroup.Dto.ServiceRequest.UpdateWebAdministrator request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController UpdateWebAdministrator {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetDeliveryAddresses(CompanyGroup.Dto.ServiceRequest.GetDeliveryAddress request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController GetDeliveryAddresses {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage AddDeliveryAddress(CompanyGroup.Dto.ServiceRequest.AddDeliveryAddress request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController AddDeliveryAddress {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage UpdateDeliveryAddress(CompanyGroup.Dto.ServiceRequest.UpdateDeliveryAddress request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController UpdateDeliveryAddress {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        [HttpPost]
        public HttpResponseMessage RemoveDeliveryAddress(CompanyGroup.Dto.ServiceRequest.RemoveDeliveryAddress request)
        {
            try
            {
                CompanyGroup.Dto.RegistrationModule.DeliveryAddresses response = service.RemoveDeliveryAddress(request);
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController RemoveDeliveryAddress {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetBankAccounts(CompanyGroup.Dto.ServiceRequest.GetBankAccounts request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController GetBankAccounts {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage AddBankAccount(CompanyGroup.Dto.ServiceRequest.AddBankAccount request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController AddBankAccount {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage UpdateBankAccount(CompanyGroup.Dto.ServiceRequest.UpdateBankAccount request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController UpdateBankAccount {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage RemoveBankAccount(CompanyGroup.Dto.ServiceRequest.RemoveBankAccount request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController RemoveBankAccount {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage AddContactPerson(CompanyGroup.Dto.ServiceRequest.AddContactPerson request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController AddContactPerson {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage SaveContactPerson(CompanyGroup.Dto.ServiceRequest.SaveContactPerson request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController SaveContactPerson {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetContactPersons(CompanyGroup.Dto.ServiceRequest.GetContactPerson request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController GetContactPersons {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage UpdateContactPerson(CompanyGroup.Dto.ServiceRequest.UpdateContactPerson request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController UpdateContactPerson {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage RemoveContactPerson(CompanyGroup.Dto.ServiceRequest.RemoveContactPerson request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("RegistrationController RemoveContactPerson {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
