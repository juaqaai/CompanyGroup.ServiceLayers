    ...
    public class VisitorController : ApiBaseController
    {
        ...
        public HttpResponseMessage SignIn(CompanyGroup.Dto.PartnerModule.SignInRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("VisitorController SignIn {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage SignOut(CompanyGroup.Dto.PartnerModule.SignOutRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("VisitorController SignOut {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetVisitorInfo(CompanyGroup.Dto.PartnerModule.VisitorInfoRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("VisitorController GetVisitorInfo {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage ChangeCurrency(CompanyGroup.Dto.PartnerModule.ChangeCurrencyRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("VisitorController ChangeCurrency {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage ChangeLanguage(CompanyGroup.Dto.PartnerModule.ChangeLanguageRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("VisitorController ChangeLanguage {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
