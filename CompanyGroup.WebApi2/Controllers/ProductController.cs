    ...
    public class ProductController : ApiBaseController
    {
        ...
        public HttpResponseMessage GetProducts(CompanyGroup.Dto.WebshopModule.GetAllProductRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetProducts {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetBannerList(CompanyGroup.Dto.WebshopModule.GetBannerListRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetBannerList {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetPriceList(CompanyGroup.Dto.WebshopModule.GetPriceListRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetPriceList {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetItemByProductId(CompanyGroup.Dto.WebshopModule.GetItemByProductIdRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetItemByProductId {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetCompletionList(CompanyGroup.Dto.WebshopModule.ProductListComplationRequest request) 
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetCompletionList {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetCompatibleProducts(CompanyGroup.Dto.WebshopModule.GetItemByProductIdRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetCompatibleProducts {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetCatalogueDetailsLogList(CompanyGroup.Dto.WebshopModule.CatalogueDetailsLogListRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("ProductController GetCatalogueDetailsLogList {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
