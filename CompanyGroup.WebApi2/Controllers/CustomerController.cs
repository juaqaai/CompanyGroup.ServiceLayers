    ...
    public class CustomerController : ApiBaseController
    {
        ...
        public HttpResponseMessage GetAddressZipCodes(string dataAreaId, string prefix) //CompanyGroup.Dto.PartnerModule.AddressZipCodeRequest request
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("CustomerController GetAddressZipCodes {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetCustomerRegistration(CompanyGroup.Dto.PartnerModule.GetCustomerRegistrationRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("CustomerController GetCustomerRegistration {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
        ...
        public HttpResponseMessage GetDeliveryAddresses(CompanyGroup.Dto.PartnerModule.GetDeliveryAddressesRequest request)
        {
            ...
            catch (Exception ex)
            {
                ...
                logWriter.Write(String.Format("CustomerController GetDeliveryAddresses {0} {1} {2}", ex.Message, ex.Source, ex.StackTrace), "Failure Category");
