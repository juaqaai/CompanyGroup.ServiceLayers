...
namespace CompanyGroup.Domain.PartnerModule
{
    ...
    {
        public InvoiceInfo(string salesId, DateTime invoiceDate, DateTime dueDate, decimal invoiceAmount, decimal invoiceCredit, string currencyCode, string invoiceId, string payment, InvoiceSalesType salesType, 
        ...
        /// számla sorok 
        /// </summary>
        public List<InvoiceLineInfo> Lines { set; get; }
        ...
        /// <returns></returns>
        public static InvoiceInfo Create(List<InvoiceDetailedLineInfo> lineInfos)
        {
