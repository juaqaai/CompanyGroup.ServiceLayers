...
namespace CompanyGroup.TraceListeners.Configuration
{
    ...
    public class FlatFileTraceListenerData : Microsoft.Practices.EnterpriseLibrary.Logging.Configuration.TraceListenerData
    {
        ...
        [Reference(typeof(Microsoft.Practices.EnterpriseLibrary.Common.Configuration.NameTypeConfigurationElementCollection<FormatterData, CustomFormatterData>), typeof(FormatterData))]
