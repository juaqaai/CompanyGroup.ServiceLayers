...
SET NOCOUNT ON
	...
	AS ( 
		...
		IF @Sequence =  0 --átlagos életkor csökkenõ, akciós csökkenõ, gyártó növekvõ, termékazonosító szerint növekvõleg,
		...
		IF @Sequence =  1 -- átlagos életkor növekvõ, akciós csökkenõ, gyártó növekvõ, termékazonosító szerint növekvõleg,
				SELECT * FROM InternetUser.Catalogue as C
