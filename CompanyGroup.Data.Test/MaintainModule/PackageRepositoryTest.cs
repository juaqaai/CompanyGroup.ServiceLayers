...
namespace CompanyGroup.Data.Test.MaintainModule
{
    ...
    public class PackageRepositoryTest
    {
        ...
        {
            CompanyGroup.Domain.MaintainModule.IPackageRepository repository = new CompanyGroup.Data.MaintainModule.PackageRepository();

            repository.ExecutePriceChangePackage();
        }
